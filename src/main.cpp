...
else if (pindexBest->nHeight+1 >1 && pindexBest->nHeight+1 <= 40)
 {
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Kamehameha!!! kamehameha!!!";
        CTransaction txNew;
        txNew.nTime = 1464339280;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1464339280;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 905664;
		if(fTestNet)
        {
            block.nNonce = 2507950 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0x0636847b536efac74fd542c73858158c59fe1830de73708e2d390f6813604cf2");
